...
# "did here", or "render this game for this object"
...
class Board:
    ...
    def make_new_board(self):
        ...
        # [...                  ],
        # [None, None, ..., None]]
        # we can see how thois represent a board!
    ...
    def assign_values_to_board(self):
        #now that we have bombs planted, let's assing a number 0-8 for all empty spaces, which
    ...
    def dig(self, row, col):
        ...
        # dig at location with no neighboring bombs -> recursively dig neighboring
        ...
        for r in range(max(0, row - 1), min(self.dim_size - 1, row + 1) + 1):
            for c in range(max(0, col - 1), min(self.dim_size - 1, col + 1) + 1):
                if(r, c) in self.dug:
                    continue # don't dig where you've alredy dug
                self.dig(r, c)
    ...
    def __str__(self):
        ...
        # get max column widths for priting
        widths = []
...
def play(dim_size = 10, num_bombs = 10):
    ...
    #           Next to a bomb
    #Step 4: Repeat steps 2 and 3a/b until there are no more place to dig -> VICTORY!
    safe = True
